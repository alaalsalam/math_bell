...
const AISHA_TOPBAR_LINES = [
  "مع الأستاذة عائشه شفلوت الحارثي ✨",
  "أبطال الحساب مع الأستاذة عائشه شفلوت الحارثي 🚀",
  "نلعب ونتعلم مع الأستاذة عائشه شفلوت الحارثي 🎯",
  "جاهزين للمغامرة مع الأستاذة عائشه شفلوت الحارثي 🌟",
];
